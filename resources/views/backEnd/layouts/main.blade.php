                        ...
                        <ul class="nav nav-pills nav-pills-custom justify-content-md-end" id="pills-tab-custom"
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" id="pills-home-tab-custom" data-toggle="pill"
                              href="/backEnd/#pills-health" role="tab" aria-controls="pills-home" aria-selected="true">
                              Day
                            </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="pills-profile-tab-custom" data-toggle="pill" href="/backEnd/#pills-career"
                              role="tab" aria-controls="pills-profile" aria-selected="false">
                              Week
                            </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="pills-contact-tab-custom" data-toggle="pill" href="/backEnd/#pills-music"
                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="py-1">
                          <img src="/backEnd/images/faces/face6.jpg" alt="image"/>
                        </td>
                        <td>
                          John Doe
                        </td>
                      ...
                      <tr>
                        <td class="py-1">
                          <img src="/backEnd/images/faces/face7.jpg" alt="image"/>
                        </td>
                        <td>
                          Henry Tom
                        </td>
