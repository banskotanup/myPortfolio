        ...
        <div class="row">
            <div class="col-12 newsletter text-center px-4">
                <div>
                    ...
                    <p class="text-white">
                        Get in touch with us today for any inquiries or assistance!</p>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-12 text-center">
                <div class="footer-logo mb-3 mb-md-0">
                    <img decoding="async" src="frontEnd/images/logo.png">
                </div>
                <div class="my-4 social-icons">
                    <h5>Follow Me</h5>
                    <ul class="list-unstyled d-flex justify-content-center align-items-center">
                        <li><a href="https://www.facebook.com/profile.php?id=100077505497002"><i class="fab fa-facebook"></i></a></li>
                        <li><a href="https://www.instagram.com/baskota.anup/"><i class="fab fa-instagram"></i></a></li>
                        <li><a href="https://www.youtube.com/channel/UCH257zZuFkH43ym6CfXZx9Q"><i class="fab fa-youtube"></i></a></li>
                    </ul>
                </div>
            </div>
